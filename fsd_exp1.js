...
// Your actual music files with enhanced data
const musicLibrary = [
    { 
        id: 1, 
...
const server = http.createServer(async (req, res) => {
    ...
    // Login Page
        ...
        req.on("end", async () => {
            ...
            res.writeHead(302, { 
                Location: `/dashboard?username=${encodeURIComponent(username)}` 
            });
            res.end();
        });
    }
                ...
                <div class="glass-container">
                    ...
                    <div class="content">
                        <div class="nav-container">
                            ...
                            <div class="nav-links">
                                <a href="/dashboard?username=${encodeURIComponent(username)}" class="nav-link active">Dashboard</a>
                ...
                <div class="glass-container">
                    ...
                    <div class="content">
                        <div class="nav-container">
                            ...
                            <div class="nav-links">
                                <a href="/dashboard?username=${encodeURIComponent(username)}" class="nav-link">Dashboard</a>
...
server.listen(PORT, () => {
    ...
    console.log(`📁 Make sure your music files are in the 'music' folder:`);
    musicLibrary.forEach(song => {
        console.log(`   - ${song.file.replace('/music/', '')}`);
    });
});